...
//  input.toLowerCase()
 {var input=que.toLowerCase();
    ...
    {
        return "He is a techncal trainer at IES.";
    }
        ...
        return "Miss. Nikhat Raza! she is a Hr of CS department at IES.";
    }
       ...
       return  "Mr. Anubhav sir ! He is a faculty member at IES.";
        ...
        return "Mr. D.P singh! He is a Sport teacher member at IES. contact details : 9098024661";
    }
    else if(input=="who is farida mam"||input=="farida"||input=="communication trainer"||input=="englsih trainer"||input=="farida mam"){
    ...
    // }
        ...
        return "There are two Libraries in IES one is at icot and second one is in iitm building";
    }
    ...
    {return"seconf shift timing: On stop: from 9:25 am to 10:30 am";}
    else if(input=="who is hod of cse"||input=="hod"||input=="who is hod")
    {
        return "Dr. Nikhat Raza";
    }else if(input=="who is  chancellorof ies "||input=="chancellor"||input=="who is chancellor")
    {
        return "Er. B.S Yadav is chancellor at IES";
    }
